...
export function JoinAccountModal({ onClose, onJoined }: JoinAccountModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      />
      <section className="relative z-10 w-full max-w-md overflow-hidden rounded-[2.5rem] border border-pink-100 bg-white animate-fade-in">
        ...
        <div className="space-y-6 p-6 pt-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border-2 border-pink-100 bg-pink-50/30 px-5 py-4 text-center font-mono text-xl font-black tracking-[0.15em] text-gray-800 outline-none transition-all placeholder:text-pink-200 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10"
            />
          </div>
